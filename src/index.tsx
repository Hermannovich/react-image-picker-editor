...
import { AddAPhoto } from "./components/Icon/add-a-photo";
import { Edit } from "./components/Icon/edit";
import { CloudDownload } from "./components/Icon/cloud-download";
          ...
          <div className="place-image">
            ...
            >
              <button
                ...
                onClick={onUpload}
              >
                <AddAPhoto size={configuration.iconSize} />
              </button>
            ...
            >
              {!configuration.hideAddBtn && (
                ...
                >
                  <AddAPhoto
                    size={
                      configuration.iconSize ? configuration.iconSize / 2 : 24
                    }
                  />
                </button>
              )}
